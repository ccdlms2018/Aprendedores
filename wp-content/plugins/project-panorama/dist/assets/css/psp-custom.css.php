...
<?php if( psp_get_option('psp_accent_color_2') ): ?>
    ...
    #psp-projects .psp-phase.color-teal h3,
...
<?php if( psp_get_option('psp_accent_color_3') ): ?>
    ...
    #psp-projects .psp-phase.color-green h3,
...
<?php if( psp_get_option('psp_accent_color_4') ): ?>
    ...
    #psp-projects .psp-phase.color-pink h3,
...
<?php if( psp_get_option('psp_accent_color_5') ): ?>
    ...
    #psp-projects .psp-phase.color-maroon h3,
...
<?php if( psp_get_option('psp_body_background') ): ?>
    body.psp-standalone-page,
    #psp-projects,
    #psp-projects .psp-standard-template {
        background-color: <?php echo psp_get_option( 'psp_body_background' ); ?>;
    }
    #psp-projects .psp-enhanced-milestones ul.psp-milestone-dots li strong.psp-single-milestone span.psp-marker-title {
        background: <?php echo psp_get_option('psp_body_background'); ?>;
        box-shadow: 0 0 20px 10px <?php echo psp_get_option('psp_body_background'); ?>;
    }
<?php endif; ?>
...
if( psp_get_option('psp_body_heading') && psp_get_option('psp_body_heading') != '#999999' ): ?>
    ...
    #psp-projects .psp-section-heading h2.psp-section-title,
    #psp-projects .psp-section-heading h1.psp-section-title,
    #psp-projects .psp-section-heading p.psp-section-data,
    #psp-projects .psp-archive-widget h4,
    #psp-projects #psp-project-calendar h2,
    #psp-projects .psp-projects-overview strong,
    #psp-projects .psp-team-list li a em,
    #psp-colophon p,
    #psp-projects .psp-projects-overview span,
    #psp-projects #psp-essentials div h4,
    #psp-projects #psp-project-summary h5,
    #psp-projects #psp-time-overview .psp-archive-list-dates h5,
...
#psp-projects #psp-comments {
    background-color: <?php echo psp_get_option('psp_footer_background'); ?>;
}
