...
class PSP_DB_Upgrade {
	...
	public function check_upgrades() {
		...
		$current_db_version = get_option( 'psp_database_version', 0 );
	...
	public function show_lite_upgrade_nag() {
        ...
        <div class="notice notice-warning">
			<p><img src="<?php echo plugins_url() . '/project-panorama/dist/assets/images/panorama-logo.png'; ?>" width="100" alt="Project Panorama"></p>
			<p><?php _e( 'Project Panorama needs to migrate your Lite projects to premium.', 'psp_projects' ); ?> <a href="<?php echo add_query_arg( 'psp_upgrade_lite', '1' ); ?>"><?php _e( 'Click here to migrate', 'psp_projects' ); ?></a></p>
        </div>
		<?php
	}
	...
	public function lite_upgrade() {
		...
		$lite_projects = new WP_Query(array('post_type' => 'psp_projects', 'meta_key' => '_psp_lite_project', 'meta_value' => '1','posts_per_page' => -1));
