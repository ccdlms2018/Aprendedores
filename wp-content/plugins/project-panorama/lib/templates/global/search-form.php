...
<form role="search" method="get" id="psp-searchform" action="">

	<div id="psp-searchform-box">
		<input type="text" name="s" id="s" placeholder="<?php esc_attr_e( 'Enter keywords...', 'psp_projects' ); ?>" onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;"/>
	    <?php
		...
		<?php do_action( 'psp_search_form_after_inputs', $status ); ?>
