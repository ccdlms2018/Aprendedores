...
$task['status'] = 	apply_filters( 'psp_task_status', $task['status'], $post_id, $phase_index, $task['ID'] );
...
<li class="<?php echo esc_attr( apply_filters( 'psp_task_classes', $task_class, $post_id, $phase_index, $task['ID'], $phases, $phase ) ); ?>" data-progress="<?php echo $task['status']; ?>">
	...
	<a id="<?php echo esc_attr($target_id); ?>" class="psp-task-title" href="#psp-open-task-panel"
	...
	<?php do_action( 'psp_after_task_name', $post_id, $phase_index, $task['ID'], $phases, $phase ); ?>
	...
	<b class="after-task-name">
		...
		<?php if($user) : ?>
			...
			<b class="psp-assigned-to">
				...
				<span class="text"><?php echo apply_filters( 'psp_task_assigned', psp_username_by_id( $user->ID ), $post_id, $phase_index, $task[ 'ID' ] ); ?></span>
			</b>
